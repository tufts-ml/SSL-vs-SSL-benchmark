...
def train(net, data_loader, train_optimizer, epoch, args, scheduler):
    net.train()
    ...
    for seed in range(0,5):
        ...
        while (time.time() - start)/3600 <= all_time:
            ...
            for epoch in range(1, args.epochs + 1):
                val_acc_1 = test(model.encoder_q, memory_loader, val_loader)
                ...
                train_loss = train(model, train_loader, optimizer, epoch, args, scheduler)
