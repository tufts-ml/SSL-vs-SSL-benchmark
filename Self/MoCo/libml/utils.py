...
def get_dataset(args, data_dir = "../data"):
    if args.dataset_name == "CIFAR10":
        train_data = CIFAR10Pair(root=data_dir, train=True, transform=train_transform, download=True)
        train_loader = DataLoader(train_data, batch_size=args.batch_size, shuffle=True, num_workers=0, pin_memory=True, drop_last=True)
        
        memory_data = CIFAR10(root=data_dir, train=True, transform=test_transform, download=True)
