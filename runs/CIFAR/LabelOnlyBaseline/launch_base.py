...
launch_args = [
    ...
    "--l_train_dataset_path /cluster/tufts/hugheslab/nfalic01/CIFAR/train",
    "--val_dataset_path /cluster/tufts/hugheslab/nfalic01/CIFAR/val",
    "--test_dataset_path /cluster/tufts/hugheslab/nfalic01/CIFAR/test",
    "--l_root_dataset_path /cluster/tufts/hugheslab/nfalic01/CIFAR",
    # DataLoader config
    "--labeledtrain_batchsize 64",
    "--num_workers 0",
    # model config
    # "--freeze_backbone",
    "--use_pretrained",
    "--arch resnet18",
    # output location
    "--train_dir /cluster/tufts/hugheslab/sslbench/experiments/CIFAR/LabelOnlyBaseline/base",
    # optimization config
    "--train_epoch 100",
    "--start_epoch 0",
    "--total_hour 24",
