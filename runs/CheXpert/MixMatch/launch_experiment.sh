...
export train_dir="/cluster/tufts/hugheslab/sslbench/experiments/$dataset_name/MixMatch_no_pretrain/data_seed$data_seed/training_seed$training_seed/$method/pretrained"
mkdir -p $train_dir
