...
export train_dir="/cluster/tufts/hugheslab/sslbench/experiments/$dataset_name/MixUp_lp/data_seed$data_seed/training_seed$training_seed/$method/pretrained$use_pretrained"
