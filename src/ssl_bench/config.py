...
dataset_configs = {
    'TissueMNIST': {
        'dataset_mean': (0.0988, 0.0988, 0.0988),
    ...
    'PathMNIST': {
        'dataset_mean': (0.7403, 0.5310, 0.7062),
    ...
    'TMED2': {
        'dataset_mean': (0.0636, 0.0636, 0.0636),
    ...
    'CheXpertEffusion': {
        'dataset_mean': (0.5064, 0.5064, 0.5064),
