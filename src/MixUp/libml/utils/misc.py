...
__all__ = ['get_mean_and_std', 'AverageMeter', 'train_one_epoch', 'eval_model',
           'save_pickle', 'calculate_plain_accuracy', 'calculate_balanced_accuracy', 'EarlyStopping']
...
#         print('l_labels: {} shape: {}'.format(l_labels, l_labels.shape))
        ...
        created_l_input, created_l_labels = mixup(
            l_input, l_input2, l_labels, args.alpha, args.num_classes)
...
#         print('created_l_labels: {}, shape: {}'.format(created_l_labels, created_l_labels.shape))
        ...
        created_l_input, created_l_labels = created_l_input.to(
            args.device).float(), created_l_labels.to(args.device).float()
